...
def main():
    ...
    if test_accuracy > baseline_accuracy:
        ...
        print(
            f"\nKNN performs better than the baseline."
        )
        ...
        print(
            "\nKNN does not outperform the baseline."
        )

        print(
            "This suggests that the selected features "
            "may provide limited predictive information "
